...
\subsection{Solution 3: Non-Interactive Masked Protocol}
...
This protocol requires the signature scheme to be deterministic, meaning $\sig(\prikey, m)$ produces the same output for fixed $(\prikey, m)$. Standard choices include:
\begin{itemize}
